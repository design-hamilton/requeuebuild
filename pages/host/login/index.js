  ...
  return (
    <Bg>
      <LoginVFlex>
        ...
        <Input title="Branch ID" name="restId" value={user.restId} onChange={(handleChange)} type="text" img={<FontAwesomeIcon icon={faIdBadge} />} />
        <Input title="User" name="userName" value={user.userName} onChange={handleChange}  type="text" img={<FontAwesomeIcon icon={faUser} />} />
        <Input title="Password" name="password" value={user.password} onChange={handleChange}  type="password" img={<FontAwesomeIcon icon={faUnlockAlt} />} />
